...
if (isset($_POST['tambah'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO expense (description, amount, date, created_by) VALUES (?, ?, ?, ?)");
...
if (isset($_POST['update'])) {
    ...
    $stmt = $conn->prepare("UPDATE expense SET description=?, amount=?, date=? WHERE id=?");
...
$totalExpense = $totalQuery->fetch_assoc()['total'] ?? 0;
?>
...
<body>
    ...
    <div class="content">
        ...
        <h3 class="fw-bold mb-3">Expense</h3>
        <p class="text-muted">Manajemen pengeluaran organisasi</p>
